...
const styles = StyleSheet.create({
  ...
  tagText: { fontSize: 10, color: Colors.white, fontWeight: '700' },
  title: { fontSize: 13, fontWeight: '700', color: Colors.text, marginBottom: 4 },
  desc: { fontSize: 11, color: Colors.textSecondary, marginBottom: 8 },
